...
fun main(args: Array<String>) {
    ...
    val serviceAccount = InputStreamReader(massEmailer.javaClass.getResourceAsStream("/${args.getOrNull(0) ?: "test.json"}"))
    ...
    for(message in list as List<Map<String, String>>) { // commented out so emails aren't accidentally sent during debug - don't trust myself :p
        //mailer.sendMail(message["to"]!!, message["subject"]!!, message["body"]!!)
    }
